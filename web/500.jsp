<html>
    ...
    <body background="<%=request.getContextPath()%>/<%= getServletContext().getInitParameter("asset-folder")%>bg2.jpg">
        <main>
            ...
            <div class="error-div">
                <div class="col1">
                    <img src="<%=request.getContextPath()%>/<%= getServletContext().getInitParameter("asset-folder")%>statuscodes/500.png"></img>
                </div>
                <div class="col2">
                    <h1>Error 500 - Uhh...</h1>
                    
                    <h3>Master Jean had a hard time sending commands to the cavalry! Please be patient and try again.</h3>
