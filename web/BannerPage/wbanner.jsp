...
<html>
    ...
    <head>
        ...
        <script id="vars" type="text/javascript">
            var _5splashpath1 = "<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/splash/<%=_5star1.getSplashArt() %>";
            var _5splashpath2 = "<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/splash/<%=_5star2.getSplashArt() %>";
            ...
            var _4splashpath4 = "<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/splash/<%=_4star4.getSplashArt() %>";
            var _4splashpath5 = "<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/splash/<%=_4star5.getSplashArt() %>";
    ...
    <body background="assets/BannerPage/bg.jpg" onload="changeContent(event, '5starWeap1', _5splashpath1 )">
        <div class="navbar">
            <ul>
                <li><button class="tab-links" id="defaultOpen" onclick="changeContent(event, '5starWeap1', _5splashpath1 )"><img  loading="lazy" src="<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/wportraits/<%= _5star1.getPortrait()%>" alt="5 Star weapon #1"></button></li>
                <li><button class="tab-links" onclick="changeContent(event, '5starWeap2', _5splashpath2 )"><img  loading="lazy" src="<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/wportraits/<%= _5star2.getPortrait()%>" alt="5 Star weapon #2"></button></li>
        ...
        <div class="main">
            ...
            <div class="box">
                <div class="column-1">
                    <img id="display" id="splashimg" loading="lazy" src="<%= getServletContext().getInitParameter("bannerpage-asset-folder") %>/splash/<%=_5star1.getSplashArt() %>" >
                </div>
                <div class="column-2">
                    <div class="row-1">
