...
<html>
    ...
    <body background="<%= getServletContext().getInitParameter("hsr-bannerpage-asset-folder") %>/bg.jpg">
        
        <div class="navbar">
            <ul>
                <li><button class="tab-links" id="defaultOpen" onclick="changeContent(event, '<%= _5star.getName() %>', _5splashpath )"><img  loading="lazy" src="<%= request.getContextPath() %>/<%= getServletContext().getInitParameter("hsr-bannerpage-asset-folder") %>/portraits/<%= _5star.getPortrait()%>" alt="5 Star character"></button></li>
                <li><button class="tab-links" onclick="changeContent(event, '<%= _4star1.getName() %>', _4splashpath1)"><img loading="lazy" src="<%= request.getContextPath() %>/<%= getServletContext().getInitParameter("hsr-bannerpage-asset-folder") %>/portraits/4stars/<%= _4star1.getPortrait() %>" alt="4 Star character #1"></button></li>
                <li><button class="tab-links" onclick="changeContent(event, '<%= _4star2.getName() %>', _4splashpath2)"><img loading="lazy" src="<%= request.getContextPath() %>/<%= getServletContext().getInitParameter("hsr-bannerpage-asset-folder") %>/portraits/4stars/<%= _4star2.getPortrait() %>" alt="4 Star character #2"></button></li>
                <li><button class="tab-links" onclick="changeContent(event, '<%= _4star3.getName() %>', _4splashpath3)"><img loading="lazy" src="<%= request.getContextPath() %>/<%= getServletContext().getInitParameter("hsr-bannerpage-asset-folder") %>/portraits/4stars/<%= _4star3.getPortrait() %>" alt="4 Star character #3"></button></li>
            </ul>
        </div>
        <div class="main">
            <div class="box">
